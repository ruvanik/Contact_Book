...
public class ContactFormGUI extends javax.swing.JFrame{
    ...
    /**
     * Creates new form ContactFormGUI
     */
    Users user;
    ...
    public ContactFormGUI(Users c) {
        initComponents();
        // used for the update or delete because it contains the id field
        // and information passed from the form does not
        this.user = c;
        ...
        //hide the insert button and show update and delete
    ...
    private void initComponents() {
        ...
        addressField.setForeground(new java.awt.Color(102, 153, 255));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.gridwidth = 5;
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        setVisible(false);
        dispose();
        new ContactFormGUI().setVisible(true);
